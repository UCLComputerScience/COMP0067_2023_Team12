...
function HomeAbout() {
  ...
  <Box sx={{position:'relative',minHeight: '15rem',backgroundImage:`url(${AboutBG})`, backgroundSize: 'cover',margin: '0 0 -2rem 0'}}>
    <section className="HomeAboutSection">
      ...
      <Typography variant="body1"  sx={{fontSize: {xs: '1rem',sm: '1.2rem',md: '1.4rem'},padding: '0 0 6rem 0.25rem ', width: '50%', textAlign: 'justify', maxHeight: '50%'}}>IBM and UCL have collaborated on various projects over the years. From Artificial Intelligence to Healthcare - pushing the boundaries of innovation. Learn more about our story.</Typography>
